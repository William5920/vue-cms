<template>
	<div class="app-container">
		...
		<nav class="mui-bar mui-bar-tab">
			...
			<router-link class="mui-tab-item-ww" to="/member">
				<span class="mui-icon mui-icon-contact"></span>
				<span class="mui-tab-label">会员</span>
			</router-link>
			<router-link class="mui-tab-item-ww" to="/shopcar">
				<span class="mui-icon mui-icon-extra mui-icon-extra-cart"><span class="mui-badge" id="badge">{{ $store.getters.getAllCount }}</span></span>
				<span class="mui-tab-label">购物车</span>
			</router-link>
			<router-link class="mui-tab-item-ww" to="/search">
...
<style lang="scss" scoped>
	...
	/*更改“mui-tab-item”类名为“mui-tab-item-ww”，解决在PhotoList组件中加顶部滑动组件单tabbar无法跳转的bug*/
